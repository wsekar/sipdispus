	...
	<div class="layout-wrapper layout-content-navbar">
		...
		<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
			...
			<ul class="menu-inner py-1">
				...
				<li class="menu-item <?php echo activate_menu('jabatan'); ?>">
					<a href="<?php echo site_url('admin/jabatan') ?>" class="menu-link">
				...
				<li class="menu-item menu-item <?php echo activate_menu('users'); ?>">
					...
					<ul class="menu-sub">
						...
						<li class="menu-item <?php echo activate_menu('ternilai'); ?>">
							<a href="<?php echo site_url('admin/ternilai') ?>" class="menu-link">
