                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-control" name="id_jabatan" id="nama_jabatan" required>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-control" name="nama_lengkap" id="nama_lengkap" disabled>
                                                    <option value=""></option>
                                                    <?php foreach ($jabatan as $j) : ?>
                                                        <option value="<?= $j['id_jabatan']; ?>"><?= $j['nama_lengkap']; ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                            </div>
                                        </div>
            ...
            function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $(`#nama_lengkap option[value=${data.id_jabatan}]`).attr('selected', 'selected');
                    },
