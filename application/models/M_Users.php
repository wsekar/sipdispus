...
class M_Users extends CI_Model
{
    ...
    public function getAllTernilai()
    {
        return $this->db->get_where("users", array('level' => 'Ternilai'))->result_array();
    }
    ...
    function jumlah_ternilai()
    {

        $query = $this->db->get_where('users', array('level' => 'Ternilai'));
        return $query->num_rows();
    }
}
